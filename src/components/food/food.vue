    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <v-ratingselect @select="selectRating" @toggle="toggleContent" :select-type="selectType"
          ...
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType,rating.text)" v-for="rating in food.ratings"
                ...
                <div class="time">{{rating.rateTime | formatDate}}</div><!--直接使用Vue的filters内置API-->
                <div class="text">
...
<script type="text/ecmascript-6">
  ...
  import {formatDate} from 'common/js/date' /*如果要引入多个方法，可以这样写{formatDate，a,c,v} 模块化编程*/
